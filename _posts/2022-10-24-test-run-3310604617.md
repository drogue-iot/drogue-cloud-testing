---
title: "✅ Test Result 2022-10-24 07:49 UTC"
date: 2022-10-24T07:49:19.989370764+00:00
...
| --- | ----- | -------| ------ | ------- | -------- | -------- |
| ✅ | 148 | 148 | 0 | 0 | 0 | 28m 54s |


**Git:** `https://github.com/drogue-iot/drogue-cloud` @ `refs/heads/main`

    Commit: 66baf177f57bea64e51d6b5035f2b3a3aea0edae
    Author: Ulf Lilleengen <lulf@redhat.com>
    Date: Tue, 18 Oct 2022 08:24:22 -0200

        Update documentation structure and add psk docs
        
        * Restructure admin guide a bit to align it more with the 'user guide'
          concept, since the scope of 'deployment' has gone beyond with
          monitoring and tracing, more day 2 operations docs.
        * Add TLS-PSK and X.509 authentication docs to device management
        * Add general section on authentication
        * Reword some places where KNative is no longer used.

**Job:** [https://github.com/drogue-iot/drogue-cloud-testing/actions/runs/3310604617](https://github.com/drogue-iot/drogue-cloud-testing/actions/runs/3310604617)
...
| [tests::http::telemetry::test_send_telemetry_user_alias::version_3](#testshttptelemetrytest_send_telemetry_user_aliasversion_3) | ✅ | 11s | 
...
| [tests::http::telemetry::test_send_telemetry_user_only::version_2](#testshttptelemetrytest_send_telemetry_user_onlyversion_2) | ✅ | 11s | 
