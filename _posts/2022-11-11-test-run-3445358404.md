...
| [tests::http::command::test_command::version_2](#testshttpcommandtest_commandversion_2) | ❌ | 0s | 
...
| [tests::mqtt::command::simple_direct::version_3::ws_1](#testsmqttcommandsimple_directversion_3ws_1) | ❌ | 0s | 
...
| [tests::mqtt::telemetry::test_send_telemetry_gateway_pass::endpoint_version_2::endpoint_ws_2::integration_version_1::integration_ws_2](#testsmqtttelemetrytest_send_telemetry_gateway_passendpoint_version_2endpoint_ws_2integration_version_1integration_ws_2) | ❌ | 0s | 
...
| [tests::mqtt::telemetry::test_send_telemetry_pass::endpoint_version_1::endpoint_ws_1::integration_version_3::integration_ws_2](#testsmqtttelemetrytest_send_telemetry_passendpoint_version_1endpoint_ws_1integration_version_3integration_ws_2) | ❌ | 0s | 
...
| [tests::mqtt::telemetry::test_send_telemetry_pass::endpoint_version_3::endpoint_ws_1::integration_version_3::integration_ws_1](#testsmqtttelemetrytest_send_telemetry_passendpoint_version_3endpoint_ws_1integration_version_3integration_ws_1) | ❌ | 0s | 
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/init/web.rs:143:35
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/init/web.rs:98:39
...
<pre>
[2022-11-11T14:06:18Z DEBUG drogue_cloud_tests::init::config] Create new config
thread &#x27;main&#x27; panicked at &#x27;Get access token: Failed to connect to web driver

Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/tests/api/mod.rs:10:10
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line
...
<pre>
-------------- TEST START --------------
[2022-11-11T14:06:18Z INFO  drogue_cloud_tests::tests::coap] entered coap_to_mqtt!
Error: Failed to connect to web driver
...
<pre>
-------------- TEST START --------------
[2022-11-11T14:06:19Z INFO  drogue_cloud_tests::tests::coap] entered coap_to_mqtt!
Error: Failed to connect to web driver
...
<pre>
[2022-11-11T14:06:24Z DEBUG drogue_cloud_tests::init::config] Create new config
Error: Acquire API key

Caused by:
    0: Failed to connect to web driver
    1: webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line
thread &#x27;main&#x27; panicked at &#x27;assertion failed: `(left == right)`
  left: `1`,
 right: `0`: the test returned a termination value with a non-zero status code (1) which indicates a failure&#x27;, /build/rustc-ZOqcvC/rustc-1.61.0+dfsg1/library/test/src/lib.rs:186:5
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/tests/registry/drg.rs:35:31
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/tests/registry/drg.rs:11:38
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/tests/registry/drg.rs:58:48
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/tests/registry/drg.rs:76:48
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/tests/registry/drg.rs:23:50
...
Caused by:
    webdriver did not create session: Expected browser binary location, but unable to find binary in default location, no &#x27;moz:firefoxOptions.binary&#x27; capability provided, and no binary flag set on the command line&#x27;, src/tests/registry/drg.rs:96:31
